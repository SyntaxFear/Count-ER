  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {/* Giorgi Shavgulidze */}
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 animate-fadeIn mb-20">
            ...
            <div className="space-y-4">
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed animate-slideInUp delay-300">
                  ...
                  Throughout his career, he has successfully managed a wide
                  range of projects, including financial due diligence, group
                  reporting, SOX compliance, and financial audits.
                </p>
                <p className="text-gray-600 leading-relaxed animate-slideInUp delay-400">
                  His diverse project management experience spans industries
                  such as Banking & Finance, Construction & Real Estate, Food &
                ...
                <p className="text-gray-600 leading-relaxed animate-slideInUp delay-500">
                  Giorgi began his professional journey at audit department in
                  KPMG Georgia, where he spent about eight years honing his
                  skills as an auditor. As a dedicated leader in the field,
                  Giorgi continues to drive innovation and excellence,
                  leveraging his extensive industry knowledge to guide Maz and
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 animate-fadeIn mb-20">
          <div className="w-full">
            ...
            <div className="space-y-4">
              <p className="text-gray-600 leading-relaxed animate-slideInUp delay-200">
                Giorgi Gikashvili brings nearly 12 years of expertise in the
                auditing and consulting. Through his tenure at audit in KPMG
                Georgia and in KPMG Luxembourg, he has gained extensive
                experience in the following sectors: Banking, Wealth Management,
                Gambling, Manufacturing (FMCG), Oil and Gas, Infrastructure,
                Financial Services, Hospitality, Retail and Mining.
              </p>
              <p className="text-gray-600 leading-relaxed animate-slideInUp delay-300">
                He was managing audits of entities in various sectors and of a
                various complexities, including listed and regulated companies.
                Giorgi has a strong analytical skills, work ethic, clear vision
                and entrepreneurial mindset.
              </p>
              <p className="text-gray-600 leading-relaxed animate-slideInUp delay-400">
                Giorgi will leverage on his motivation, knowledge and experience
                to establish this Company as a successful brand in Georgia and
                worldwide.
              </p>
            </div>
          </div>
        ...
        <div className="mt-20 animate-fadeIn" id="contact">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8">
            <a
              href="tel:+995555764364"
              className="flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-md transition-all duration-300 hover:shadow-lg hover:bg-blue-50 hover:scale-105 cursor-pointer"
            >
              <svg
            ...
            <a
              href="mailto:gshavgulidze@maz.ge"
              className="flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-md transition-all duration-300 hover:shadow-lg hover:bg-blue-50 hover:scale-105 cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
