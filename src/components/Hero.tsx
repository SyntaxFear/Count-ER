...
function Hero() {
  return (
    <section className="relative h-[90vh] p-4 sm:p-6 md:p-8 pt-10">
      <div className="absolute top-4 right-4 z-50 bg-yellow-400 text-blue-900 px-4 py-2 rounded-full shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300">
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen text-white p-4 sm:p-6 md:p-8 lg:p-12 max-w-7xl mx-auto">
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light mb-2 text-blue-400">
          MAZ AND PARTNERS
        </h2>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight">
          Transforming Business
          <br />
          <span className="text-blue-400">Through Financial Expertise</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start">
          <Link
            href={"#about"}
            className="w-auto bg-blue-500 hover:bg-blue-600 transition-all text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base lg:text-lg font-semibold shadow-lg hover:shadow-xl"
          >
            Company
          </Link>
          <Link
            href={"#team"}
            className="w-auto bg-transparent border-2 border-white hover:bg-white hover:text-blue-800 transition-all text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base lg:text-lg font-semibold"
          >
            Team
          </Link>
        </div>
